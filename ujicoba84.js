...
// ============================================================
    ...
    const finishInitialization = () => { 
        ...
        // --- LOGIKA WIDGET TERTANAM (AUTO-START) ---
        preloadGameAudios();
        DOM.modelViewer.style.visibility = "visible";
        DOM.modelViewer.play(); // Putar animasi Idle
        ...
        if (state.userData.username) { 
            ...
            // Render pesan sapaan otomatis jika layar chat masih kosong
            if (DOM.chatScrollArea.children.length === 0 && state.chatHistory.length > 1) {
                addMessageToChat("bot", state.chatHistory[1].parts[0].text);
            }
        } else {
            // Jika pengunjung baru (belum ada nama), langsung tembak popup
            DOM.usernamePopup.style.display = 'flex';
            DOM.usernameInput.focus();
        }
        // -------------------------------------------
...
// ============================================================
    // MIXER AUDIO (SETTING VOLUME) - VERSI OGG SEAMLESS
    // ============================================================

...
// ============================================================
    ...
    const spawnMasterAura = () => {
        ...
        for (let i = 0; i < boltCount; i++) {
            ...
            // [FIX] UKURAN TINGGI DIPERBESAR DRASTIS (150px sampai 400px)
            ...
            setTimeout(() => { if (bolt.parentNode) bolt.remove(); }, 350);
        }
    };

    // ============================================================
    // GENERATOR IDLE AURA (Aura Merah Otomatis)
    // ============================================================
    let masterIdleAuraTimer = null; 
        ...
        if (state.userData.activeCharacter === 'master_form') {
            masterIdleAuraTimer = setInterval(() => {
                ...
                for (let i = 0; i < boltCount; i++) {
                    ...
                    // [FIX] UKURAN TINGGI IDLE DIPERBESAR (60px sampai 160px)
                    ...
                    container.appendChild(bolt);
                    setTimeout(() => { if (bolt.parentNode) bolt.remove(); }, 250);
                }
            }, 600); 
        }
    };
...
// ============================================================
    ...
    const initialize = () => {
        if (!document.getElementById('real-bloom-engine')) {
            const svgBloom = `
            <svg width="0" height="0" style="position:absolute;z-index:-1;" id="real-bloom-engine">
                <defs>
                    <!-- Ini adalah Multi-Pass Gaussian Blur persis seperti di Game Engine -->
                    <filter id="true-bloom" x="-100%" y="-100%" width="300%" height="300%">
                        ...
                        <!-- Additive Blending (Menumpuk Cahaya) -->
                        <feMerge>
            ...
            document.body.insertAdjacentHTML('beforeend', svgBloom);
        }
        initializeUserData();
        setupEventListeners();
        setupAudioMixer();

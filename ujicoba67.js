...
// Fungsi Transisi Layar Henshin (PREMIUM MATERIALIZE)
        ...
        if (action === 'white') {
            ...
            if (!w && !b) {
                ...
                if (w && !b) {
                    ...
                    // HENSHIN DEFAULT
                    DOM.blasterComboText.textContent = "HENSHIN: DEFAULT";
                    if(blasterImg) blasterImg.classList.add('weapon-shake');
    ...
    playHenshinTransition('kaitou', '#00eaff', 'rgba(0, 234, 255, 0.2)'); 
                    ...
                    if (state.userData.unlockedCharacters.includes('master_form')) {
                        DOM.blasterComboText.textContent = "MASTER FORM!!!";
                        if(blasterImg) blasterImg.classList.add('weapon-shake'); 
    ...
    playHenshinTransition('master_form', '#f1c40f', 'rgba(241, 196, 15, 0.2)'); 
        ...
        if (action !== 'trigger') {
            ...
            else if (state.blasterBlackActive) DOM.blasterComboText.textContent = "READY: HENSHIN";
        }
    };
...
// ============================================================
    ...
    const setupAudioMixer = () => {
        ...
        if (DOM.sfxTring) DOM.sfxTring.volume = 0.7;
        ...
        if (DOM.sfxBlastNormal) DOM.sfxBlastNormal.volume = 0.9;

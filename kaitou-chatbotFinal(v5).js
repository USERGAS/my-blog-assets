document.addEventListener("DOMContentLoaded", () => {
    ...
    // ================== KONFIGURASI ==================
    const CONFIG = {
        APPS_SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbxVkScZTtju8OQqJM3T7c5vf9Eb1AiLbma67eJ7k_uSQvZT7dDFE1717-WfiZjDzjdsYw/exec',
        SHOP_ITEMS: [{ id: 'access_code', name: 'Kode Akses 2 Hari Link Tanpa Iklan', icon: '🔑', cost: 900 }, discountCost: 100 }],
        DISCOUNT_END_DATE: '2025-09-31T23:59:59',
        ...
        CONFIG.SHOP_ITEMS.forEach(item => {
            ...
            if (now <= discountEndDate && item.discountCost) {
                ...
                priceHTML = `<span class="item-price" style="color: #4caf50; font-weight: bold;">
                               <del style="color: #999;">${item.cost} Koin</del> ${item.discountCost} Koin (EVENT!)
                             </span>`;
            }
